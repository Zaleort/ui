    ...
    <div>
      ...
      <span
        ...
        :class="{
          ...
          'is-highlight-start': day.isHighlightStart,
          'is-highlight-end': day.isHighlightEnd,
        }"

        class="ui-date__cell day"
...
export default {
  ...
  computed: {
     ...
     */
    isLeftNavDisabled() {
      return this.isPreviousMonthDisabled(this.pageTimestamp);
    },
    /**
     ...
     */
    isRightNavDisabled() {
      return this.isNextMonthDisabled(this.pageTimestamp);
    },
  },
  methods: {
    selectDate(date) {
